...
var MagicDate = /** @class */ (function () {
    ...
    MagicDate.makeDate = function (dateFactoryConfig, options) {
        ...
        try {
            if (dateFactoryConfig.dt) {
                ...
                var __dateObject_1 = MagicDate.SIMPLE_DATE;
                var __isoDate_1 = {};
                [
                    "year",
                    "month",
                    ...
                    var _a, _b, _c, _d;
                    var validityError = MagicDate.validateDateConfig(parseInt((_a = dateFactoryConfig[v]) === null || _a === void 0 ? void 0 : _a.toString()), v);
                    if (validityError) {
                    ...
                    switch (v) {
                        case "year":
                            __isoDate_1[v] = (_b = __dateObject_1[v]) === null || _b === void 0 ? void 0 : _b.toString();
                            break;
                        case "microSecond":
                            __isoDate_1[v] = MagicDate.padding(((_c = __dateObject_1[v]) === null || _c === void 0 ? void 0 : _c.toString()) || "", __microSecondLength, "0");
                            break;
                        default:
                            __isoDate_1[v] = MagicDate.padding(((_d = __dateObject_1[v]) === null || _d === void 0 ? void 0 : _d.toString()) || "", 2, "0");
                    }
                });
    ...
    MagicDate.getDateFromTo = function (start, end, abstraction, weekStart, includeEndDate) {
        ...
        while (i && endNumeric && i < endNumeric + endDatePadding) {
            var __dateObject = MagicDate.SIMPLE_DATE;
            __dateObject.dt = i;
    ...
    MagicDate.validateDatePosition = function (a, b) {
        var __dateObjectA = MagicDate.SIMPLE_DATE;
        __dateObjectA.dt = a;
        var __dateObjectB = MagicDate.SIMPLE_DATE;
        __dateObjectB.dt = b;
    ...
    MagicDate.prototype.today = function (date) {
        if (date === void 0) { date = null; }
        (date === null || date === void 0 ? void 0 : date.getDate()) || (this.dtObj && this.dtObj.getDate());
        return this;
    };
    /**
    ...
    MagicDate.prototype.next = function (command) {
        ...
        if (["year", "month"].indexOf(abstraction) > -1) {
            ...
            var __simpleDate = MagicDate.SIMPLE_DATE;
    ...
    MagicDate.prototype._formatWithLeadingZeroes = function () {
        ...
        this.yearStr = (year === null || year === void 0 ? void 0 : year.toString()) || null;
        ...
        this.microSecondStr =
            (microSecond !== null &&
                MagicDate.padding(microSecond.toString(), this.options.microSecondsLength || MagicDate.DEFAULT_MICRO_SECONDS_LENGTH, "0")) ||
                null;
        return this;
    };
