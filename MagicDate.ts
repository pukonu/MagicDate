...
class MagicDate implements DateInterface {
    ...
    private _castMask : string = '%Y-%m-%d %H:%i:%s:%u';
     ...
     */
    public static makeDate(dateFactoryConfig : SimpleDateInterface = new SimpleDateInterface()) : MagicDate {
     ...
     */
    public static getDateFromTo($start : MagicDate, $end : MagicDate, $abstraction : string = "day", $weekStart : WeekDayInterface = null, $includeEndDate : boolean = true) : Array < MagicDate > {
...
/**
     ...
     * @param $year
     */
private static getDateFromWeekNum($weekNum, $year) : MagicDate {
    const __dateObject = new SimpleDateInterface();
...
/**
     ...
     * @param $includeEndDate
     */
public static getDatesFromWeekNum($weekNum, $year = null, $abstraction = "day", $weekStart = null, $includeEndDate = false) : Array < MagicDate > {
...
/**
     ...
     * @param year
     */
public static getMonthFirstDate(dateObject?: MagicDate, month?: number, year?: number) : MagicDate {
...
/**
     ...
     * @param year
     */
public static getMonthLastDate(dateObject?: MagicDate, month?: number, year?: number) : MagicDate {
    if(dateObject || (month && year)) {
        if (dateObject) {
            month = dateObject.month
            year = dateObject.year;
...
/**
     ...
     * @param b
     */
public static validateDatePosition(a, b) : boolean {
...
private static validateDateConfig(value : number, type : string) : string {
    const __dateObject = new SimpleDateInterface();
...
private static timeMult(type) : number {
